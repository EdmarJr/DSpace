 ...
 * @version $Revision$
 */
public class BrowseListTagByEdmar extends TagSupport
{
	 /** log4j category */
    private static Logger log = Logger.getLogger(BrowseListTagByEdmar.class);
...
//            out.print("</tr>");
            ...
            for (int i = 0; i < items.length; i++)
            {
                ...
                LinkedList<String> metadatas = new LinkedList<String>();
...
//                    out.print((emph[colIdx] ? "<strong>" : "") + metadata + (emph[colIdx] ? "</strong>" : ""));
                ...
                sb.append("<a href=\"#\" class=\"thumbnail\"> <img src=\""+(metadatas.get(0) != null ? metadatas.get(0) : "") +"\" alt=\"\"></a>");
                sb.append("</div>");
                sb.append("<div class=\"col-md-10\">");
                sb.append((metadatas.get(1) != "" ? metadatas.get(1) : "")+"<br />");
                sb.append((metadatas.get(2) != "" ? metadatas.get(2) : ""));
                sb.append("<strong>("+(metadatas.get(3) != "" ? metadatas.get(3) : "")+")</strong> <br />"+(metadatas.get(4) != "" ? metadatas.get(4) : ""));
                sb.append("</div></div></div><hr/>"); 
